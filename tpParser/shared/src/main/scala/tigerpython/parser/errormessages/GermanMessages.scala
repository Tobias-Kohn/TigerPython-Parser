...
object GermanMessages extends ModifiableErrorMessages {
  ...
  protected def _getMessage(msg: ErrorCode.Value): String =
    msg match {
      ...
      case CANNOT_CALL_VALUE => "'%s' kann nich mit Klammern aufgerufen werden, weil es weder eine Funktion noch ein anderes aufrufbares Objekt ist."
      ...
      case CANNOT_USE_STAR_IN_DICT =>	"Stern-Ausdrücke können nicht als dictionary-Werte verwendet werden."
      case CASE_REQUIRED => "Ein 'match'-Block kann nur 'case'-Anweisungen enthalten."
      ...
      case DOUBLE_CALL	=>	"Der Rückgabewert einer Funktion kann nicht aufgerufen werden."
      ...
      case DOUBLE_WALRUS	=>	"Um einen Ausdruck an zwei Namen zuzuweisen, müssen Klammern verwendet werden: '%s := (%s := ...)'."
      ...
      case EXTRA_BRACKETS	=>	"Das Schlüsselwort '%s' hat keine Klammern '()'."
      case EXTRA_DEF	=>	"Ein überflüssiges 'def' kommt vor."
      ...
      case EXTRA_LINE_NUMBER	=>	"Am Anfang der Linie stehen Zeilennummern, die entfernt werden sollten."
      ...
      case GLOBAL_WITH_ASSIGNMENT	=>	"'%s' kann nicht mit einer Zuweisung verwendet weden."
      ...
      case INVALID_CONDITION =>	"'%s' ist keine gültige Bedingung."
      case INVALID_EXPR_ASSIGN_TARGET	=>	"Das Ziel der Zuweisung eines Ausdrucks ':=' muss ein Name sein, nicht '%s'."
      ...
      case MISSING_EXPRESSION	=>	"Hier fehlt ein Ausdruck oder ein Wert."
      case MISSING_LEFT_BRACKET => "Fehlende öffnende Klammer: '%s'"
      case MISSING_LEFT_PARENTHESIS => "Fehlende öffnende Klammer."
      case MISSING_LINE_BREAK => "Das '%s' muss auf einer neuen (eingerückten) Zeile stehen."
      ...
      case REPEAT_NOT_ENABLED => "Der repeat-Befehl ist nicht allgemein verfügbar."
      ...
      case THIS_IS_NOT_PIP	=>	"'%s' kann hier nicht verwendet werden."
      case THIS_IS_NOT_REPL	=>	"Solche Anweisungen werden in der interaktiven Konsole augerufen, nicht aber im Code-Editor."
      ...
      case TRY_INCOMPLETE_STRUCTURE	=> "Eine 'try'-Anweisung muss von einem 'except'- oder 'finally'-Block gefolgt werden."
      case TUPLE_NEEDS_PARENS => "Dieses Tuple muss in Klammern eingeschlossen werden."
      case TYPO	=> "Hier scheint ein Tipfehler vorzuliegen: Anstelle von '%s' sollte es wahrscheinlich '%s' sein."
      ...
      case USE_DOT_NOT_COMMA => "Gebrochene Zahlen werden mit Punkt geschrieben, nicht mit Komma."
      ...
      case USE_PYTHON_POWER	=> "Verwende '**' anstelle von '^'."
      case USE_REPEAT_INSTEAD_OF_WHILE => "Verwende 'repeat' anstelle von 'while'."
      case USE_SEMICOLON_INSTEAD_OF_COMMA	=> "Verwende einen Strichpunkt anstelle des Kommas."
      case USE_UNDERLINE_NOT_MINUS	=> "Verwende einen Unterstrich '_' anstelle des Bindestrichs '-' (Minuszeichen)."
      ...
      case WALRUS_AS_STATEMENT	=>	"Du kannst ':=' nur in Ausdrücken verwenden. Verwende '=' für Zuweisungen."
      case WRONG_BRACKET => "Falsche Klammer: hier braucht es eine '%s' anstelle von '%s'"
      case WRONG_STRING_DELIMITER	=>	"%s kann nicht als Begrenzungszeichen für Zeichenketten (Strings) verwendet werden. Verwende entweder \' oder \"."
