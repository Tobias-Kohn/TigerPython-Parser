...
object ErrorCode extends Enumeration {
  ...
  final val AND_CONNECTS_CMP_NOT_VALUES = Value("AND_CONNECTS_CMP_NOT_VALUES")
  ...
  final val CANNOT_USE_STAR_IN_DICT = Value("CANNOT_USE_STAR_IN_DICT")      // NEW 27-MAY-2026
  ...
  final val GLOBAL_WITH_ASSIGNMENT = Value("GLOBAL_WITH_ASSIGNMENT")    // NEW 28-MAR-2026
  ...
  final val MISSPELLED_NAME = Value("MISSPELLED_NAME")        // NEW 15-MAY-2026
  ...
  final val USE_UNDERLINE_NOT_MINUS = Value("USE_UNDERLINE_NOT_MINUS")  // NEW 15-MAY-2026
